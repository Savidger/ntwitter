 ...
 * USER TIMELINE
 */
Twitter.prototype.userTimeline = function(screen_name, params, callback) {
    if (typeof params === 'function') {
        callback = params;
        params = {};
    }
    ...
    var url = this.options.statuses_base + '/user_timeline.json';
    params = utils.merge(params, {screen_name:screen_name});
    this.get(url, params, callback);
    return this;
}
